...
When we compare the temperatures for `season` and `season2`, we realise that `season` has higher temperatures in autumn than summer, which does not seem accurate. Thus, we are going to use `season2` instead of `season1`.
```{r}
